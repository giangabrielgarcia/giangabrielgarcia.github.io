        ...
        <div className='about hide-body'>
            <div className='img-container'>
                ...
                <div> 
                    ...
                    <a target='_blank' rel='noreferrer' href = 'http://www.twitter.com/gian_garcia_'>
                    <i className="bi-twitter small-icons"></i>
                    </a>    
                    <a target='_blank' rel='noreferrer' href = 'https://scholar.google.com/citations?user=dbT08k0AAAAJ&hl=en&oi=ao'>
                    <i className="ai ai-google-scholar small-icons" ></i>
                    </a>   
                    <a target='_blank' rel='noreferrer' href = 'https://orcid.org/0000-0001-9315-0195'>
                    <i className="ai ai-orcid small-icons"></i>
                    </a>   
                    <a target='_blank' rel='noreferrer' href = 'https://www.linkedin.com/in/gian-gabriel-garcia-phd-7a04b785/'>
         ...
         <div className='about-text'>
             ...
             <p>I'm an Assistant Professor in the <a href = "https://www.isye.gatech.edu/" target='_blank' rel='noreferrer' className='reg-link'>H. Milton Stewart School of Industrial and Systems Engineering</a> (ISyE) at Georgia Tech. 
            ...
            <p>Prior to joining ISyE, I was a Postdoctoral Research Fellow in the <a className='reg-link' href="https://www.mgh-ita.org/" target='_blank' rel='noreferrer'>Massachusetts General Hospital Institute for Technology Assessment</a> at the Harvard Medical School. 
		    I obtained my PhD in 2020 and MS in 2016 from the <a className='reg-link' href="https://ioe.engin.umich.edu" target='_blank' rel='noreferrer'>Department of Industrial and Operations Engineering</a> at the University of Michigan
		    and my BS in Industrial Engineering from the <a  href ="https://www.engineering.pitt.edu/Departments/Industrial/" target='_blank' rel='noreferrer' className='reg-link'>University of Pittsburgh</a> in 2014.</p>
