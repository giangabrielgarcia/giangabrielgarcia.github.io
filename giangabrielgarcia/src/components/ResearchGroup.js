...
const alumniPhD = [
    ...
    {
        name: 'Sun Ju Lee', degree: 'PhD in Operations Research, Georgia Tech (Graduated 2025)', 
...
const alumniOther = [
    ...
    {
        name: 'Yang Yang', degree: 'BS in Industrial & Systems Engineering, BS in Mathematics, Georgia Tech (Graduated 2025)', 
    ...
    {
        name: 'Yixuan Long', degree: 'MS in Operations Research, Georgia Tech (Graduated 2025)', 
    ...
    {
        name: 'Amaya McNealey', degree: '', currentposition: 'PhD in Industrial Engineering, Georgia Tech', coadvisor: 'Lauren Steimle', 
        bio: 'I am a PhD student in Industrial Engineering at the H. Milton Stewart School of Industrial and Systems Engineering. I received my B.S. in Industrial and Systems Engineering from North Carolina A&T State University. My research interests are primarily related to health policy applications along with social determinants of health. I am especially interested in equity and fairness in Machine Learning algorithms along with methods to ensure interpretability.', photo: mcnealey, linkedin: "https://www.linkedin.com/in/amaya-mcnealey-a90247170/",
    ...
    {
    name: 'Xinyu Chen', degree: 'BS in Biomedical Engineering, Georgia Tech (Graduated 2023)', bio: `I am a BS student in the Wallace H. Coulter Department of Biomedical Engineering with GT and Emory. My reseasrch interests revolve around optimization, process improvement, analyses, and planning for health system problems. Currently, I'm working on using modeling and data analysis to improve the decision-making for sports-related concussions.`, linkedin: "https://www.linkedin.com/in/xinyu-laura-chen-457a50121/", photo: chen, currentposition: 'MS in Biomedical Informatics, Harvard University'

  },


    {
        name: 'Venkatesh Nori Naga', degree: 'MS in Industrial Engineering, Georgia Tech (Graduated 2022)', linkedin:"https://www.linkedin.com/in/venkatesh-nori-naga" , photo: filler, currentposition: 'Senior Data Analyst, Home Depot'
    },    
    
    
    {
        name: 'Jasbir Singh', degree: 'MS in Industrial Engineering, Georgia Tech (Graduated 2022)', linkedin: "https://www.linkedin.com/in/jasingharauz/", photo: filler, currentposition: 'Solutions Design Engineer, Amazon'
    },


    {
        name: 'Jiahui Luo', degree: 'MS in Statistics, Georgia Tech (Graduated 2021)', linkedin: "https://www.linkedin.com/in/jiahuiluo/", photo: filler, currentposition: 'PhD student, Dartmouth College'
    },

    
    {
        name: 'Mateen Jangda', degree: 'BS in Industrial & Systems Engineering, Georgia Tech (Graduated 2024)', linkedin: "https://www.linkedin.com/in/mateen-jangda", photo: filler    }
]
    ...
    return (
        <div className='body-container'>
            <div className='hide-body'>
                <h4 className='page-title'>Current PhD Students</h4>
                <hr></hr>
                {
                ...
                <h4 className='page-title'>Current Postdoctoral Research Fellows</h4>
                <hr></hr>
            ...
            */}
            ...
            <h4 className='page-title'>Graduated PhD Students</h4>
                <hr></hr>
                {
                    alumniPhD.map((student) => {                       
            ...
            <h4 className='page-title'>Other Past Advisees</h4>
                <hr></hr>
                {
                    alumniOther.map((student) => {
                        ...
                        {student.currentposition != null && 
                        <p className='mb-0'>Last Known Position: {student.currentposition}</p>}
                        <p className='mb-0'> {student.degree}</p>
                        { student.awards != null && <ul> 
                            {student.awards.map((award)=>{
                            return (
                        ...
                        {/*
                        {student.personalSite != null && <p><a target='_blank' rel='noopener noreferrer' href={student.personalSite} className='reg-link'>Personal Website</a></p>}
                        {student.linkedin != null && <p><a target='_blank' rel='noopener noreferrer' href={student.linkedin} className='reg-link'>LinkedIn</a></p>}
                        */}
