...
const submittedPapers = [
  {id: 1, text: 'X. Gong, S.J. Lee, G.-G. P. Garcia (2023). Analysis of Monotone Policy Iteration for Interpretable Policies in Markov Decision Processes: Impact of State Ordering Rules. ', status: '(Submitted)'},
...
const peerReviewedPapers = [
  ...
  { id: 18, text: `K. E. Valerio, J. B. Caccese, A. P. Kontos, T. A. Buckley, G.-G. P. Garcia, N. Port, S. P. Broglio, T. W. McAllister, M. A. McCrea, P. F. Pasquina, J. P. Hayes, and CARE Consortium Investigators, (2022). Primary and Secondary Risk Factors Associated with Concussion Symptom Clusters in Collegiate Athletes: Results from the NCAA-DoD Grand Alliance CARE Consortium, `, journal: "The Orthopaedic Journal of Sports Medicine", issue: ", 11(4). ", link: 'https://doi.org/10.1177%2F23259671231163581' },

  { id: 17, text: `J. B. Caccese, G.-G. P. Garcia, A.P. Kontos, N. Port, K. Valerio, S.P. Broglio, M.A. McCrea, T.W. McAllister, P.F. Pasquina, T.A. Buckley, (2022). Test-Retest Reliability and Efficacy of Individual Symptoms in Concussion Management, `, journal: "Clinical Journal of Sports Medicine", issue:", 33(1), 52-60. ", link: "https://doi.org/10.1097/JSM.0000000000001084" }, 
  ...
  { id: 15, text: `G.-G. P. Garcia, R. Dehghanpoor, E. J. Stringfellow, M. Gupta, J. Rochelle, E. Mason, T. Pujol, M. S. Jalali, (2022). Identifying and Characterizing Advice-Seekers for Recovery from Opioid Use Disorder: Social Media Analysis, `, journal: "International Journal of Environmental Research and Public Health", issue:", 19(10), 6281. ", link: "https://doi.org/10.3390/ijerph19106281" },

  { id: 14, text: `G.-G. P. Garcia, E.J. Stringfellow, C. DiGennaro, N. Poellinger, J. Wood, S.E. Wakeman, M.S. Jalali, (2022). Opioid Overdose Decedent Characteristics during COVID-19, `, journal: "Annals of Medicine", issue:", 54(1), 1081–1088. ", link: "https://doi.org/10.1080/07853890.2022.2067350" },

  { id: 13, text: `C.-Y. Liao, G.-G. P. Garcia, C. DiGennaro, M.S. Jalali, (2022). Racial Disparities in Opioid Overdose Deaths in Massachusetts, `, journal: "JAMA Network Open", issue:", 5(4), e229081. ", link: "https://doi.org/10.1001/jamanetworkopen.2022.9081" }, 

  { id: 12, text: `G.-G. P. Garcia , C.M. Schumb, M.S. Lavieri, H. Koffijberg, T.W. McAllister, M.A. McCrea, S.P. Broglio, (2022). Developing Insights for Possible and Probable Acute Concussions Using Cluster Analysis, `, journal: "Journal of Neurotrauma", issue:", 39 (1-2), 102-113. ", link: "https://doi.org/10.1089/neu.2020.7399"},

  { id: 11, text: `C. DiGenarro, G.-G. P. Garcia, E.J. Stringfellow, M.S. Jalali. (2021). Changes in Characteristics of Drug Overdose Death Trends during the COVID-19, `, journal: "International Journal of Drug Policy", issue:  ", 2021 Dec;98:103392. ", link: 'https://doi.org/10.1016/j.drugpo.2021.103392'}, 

  { id: 10, text: `L.L. Czerniak, S.W. Liebel, G.-G. P. Garcia, M.S. Lavieri, M.A. McCrea, T.W. McAllister, S.P. Broglio, (2021). Sensitivity and Specificity of Computer-Based Neurocognitive Assessments in Sport-Related Concussion: Findings from the NCAA-DoD CARE Consortium, `, journal: "Sports Medicine", issue:
  ", 51 (2), 351-365.", link: "https://doi.org/10.1007/s40279-020-01393-7" }, 

  { id: 9, text: `S.W. Liebel, K.L. Van Pelt, G.-G. P. Garcia, L.L. Czerniak, M.A. McCrea, T.W. McAllister, S.P. Broglio, (2020). The Relationship Between Sport-related Concussion and Sensation-Seeking, `, journal:  "International Journal of Molecular Sciences", issue:", 21 (23), 9097. ", link: "https://doi.org/10.3390/ijms21239097" }, 
  ...
  { id: 3, text: `G.J. Schell, G.-G. P. Garcia , M.S. Lavieri, J.B. Sussman, R.A. Hayward, (2018). Optimal Coinsurance Rates for a Heterogeneous Population under Inequality and Resource Constraints, `, journal: "IISE Transactions", issue:", 51 (1), 74-91. ", link: "https://doi.org/10.1080/24725854.2018.1499053", download: {manuscript3} }, 
  ...
  { id: 1, text: `M. Mofrad, G.-G. P. Garcia, L.M. Maillart, B.A. Norman, J. Rajgopal, (2016). Customizing Immunization Clinic Operations to Minimize Open Vial Waste, `, journal: "Socio-Economic Planning Sciences", issue:", 54 (March 2016), 1-17. ", link: "https://doi.org/10.1016/j.seps.2015.10.007" }
]
        ...
        <hr></hr>
          <div className='research-text'>
            ...
            <div className='research-para-margin'>
                ...
                <p>Medical decision-making, concussion management, opioid overdose, maternal health, chronic disease management</p>
            </div>
            <div>
