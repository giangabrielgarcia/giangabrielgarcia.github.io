...
const submittedPapers = [
  ...
  {text: 'Y. Xie, G.-G. P. Garcia, E. Song, and N. Serban (2024). Evaluating Access to Pediatric Psychosocial Services: A Discrete Event Simulation Approach under Uncertainty. ', status: '(Submitted)'},
  ...
  {text: 'C.-Y. Liao, G.-G. P. Garcia, K. Paynabar, Z. Dong, Y. Xie, and M. S. Jalali (2024). Tides Need STEMMED: A Locally Operating Spatio-Temporal Mutually Exciting Point Process with Dynamic Network for Improving Opioid Overdose Death Prediction. ', status: '(Under revision)', link: 'https://arxiv.org/abs/2211.07570'},


  {text: 'Y. Yang, C.-Y. Liao, E. Keyvanshokooh, H. Shao, M. B. Weber, F. Pasquel, and G.-G. P. Garcia (2024). A Responsible Framework for Assessing, Selecting, and Explaining Machine Learning Models in Cardiovascular Disease Outcomes Among People with Type 2 Diabetes. ', status: '(Under revision)'},
...
const peerReviewedPapers = [
  ...
  {id: 26, text: 'S.J. Lee, X. Gong, G.-G. P. Garcia (2024). Modified Monotone Policy Iteration for Interpretable Policies in Markov Decision Processes and the Impact of State Ordering Rules. ', journal: 'Annals of Operations Research. ', status: '(Accepted)', link:'https://rdcu.be/dOSk2'}, //'https://optimization-online.org/?p=23723'},

  {id: 25, text: 'S. Ma, A. Dehghanian, G.-G. P. Garcia, and N. Serban (2024). Learning Hidden Markov Models with Structured Dynamics. ', journal: 'INFORMS Journal on Computing. ', status: '(Accepted)', link: 'https://doi.org/10.1287/ijoc.2022.0342'},
