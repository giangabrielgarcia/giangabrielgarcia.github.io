...
const peerReviewedPapers = [
  ...
  {id: 28, text: 'Y. Yang, C.-Y. Liao, E. Keyvanshokooh, H. Shao, M. B. Weber, F. Pasquel, and G.-G. P. Garcia (2025). A Responsible Framework for Assessing, Selecting, and Explaining Machine Learning Models in Cardiovascular Disease Outcomes Among People With Type 2 Diabetes: Methodology and Validation Study. ', journal: 'JMIR Medical Informatics', issue: ', 13, e66200.', link: 'https://doi.org/10.2196/66200'},

  {id: 27, text: 'H. S. Pandey, B. Lahijanian, J. D. Schmidt, R. C. Lynall, S. P. Broglio, T. W. McAllister, M. A. McCrea, P. F. Pasquina, and G.-G. P. Garcia (2024). Quantifying the Diagnostic Utility of Baseline Testing in Concussion Management: An Analysis of Collegiate Athletes From the NCAA-DoD CARE Consortium Dataset. ', journal: 'American Journal of Sports Medicine', issue: ', 53(1), 181-191.', link: 'https://doi.org/10.1177/03635465241296868'},

  {id: 26, text: 'S.J. Lee, X. Gong, G.-G. P. Garcia (2024). Modified Monotone Policy Iteration for Interpretable Policies in Markov Decision Processes and the Impact of State Ordering Rules. ', journal: 'Annals of Operations Research', issue: ", 347, 783–841. ", link:'https://rdcu.be/dOSk2'}, //'https://optimization-online.org/?p=23723'},

  {id: 25, text: 'S. Ma, A. Dehghanian, G.-G. P. Garcia, and N. Serban (2024). Learning Hidden Markov Models with Structured Dynamics. ', journal: 'INFORMS Journal on Computing', issue: ', 37(3), 531–556. ', link: 'https://doi.org/10.1287/ijoc.2022.0342'},

  {id: 24, text: 'L. B. Lempke, A. J. Boltz, G.-G. P. Garcia, R. A. Syrydiuk, H. S. Pandey, M. A. McCrea, T. W. McAllister, and S. P. Broglio (2023). Optimizing Baseline and Post-Concussion Assessments Through Factor Structure Analysis: Findings from the NCAA-DoD CARE Consortium. ', journal: 'The Clinical Neuropsychologist', issue: ', 38(5), 1156-1174.', link: 'https://doi.org/10.1080/13854046.2023.2271614'},

  {id: 23, text: `G.-G. P. Garcia , L.L. Czerniak, M.S. Lavieri, S.W. Liebel, K. Van Pelt, P.F. Pasquina, T.W. McAllister, M.A. McCrea, S.P. Broglio, and CARE Consortium Investigators (2023). Tailoring the Symptom-Free Waiting Period in Return-to-Play from Concussion: A Simulation Analysis Using CARE Consortium Data. `, journal: "Sports Medicine", issue: ', 53(1), 2513-2528', link: 'https://doi.org/10.1007/s40279-023-01901-5' },
  ...
  { id: 21, text: `G.-G. P. Garcia , L. N. Steimle, W. J. Marrero, and J. B. Sussman (2024). Interpretable Policies and the Price of Interpretability in Hypertension Treatment Planning. `, journal: "Manufacturing & Service Operations Management", issue: ", 26(1), 80-94.", link: "https://doi.org/10.1287/msom.2021.0373", download: manuscript5 },
...
peerReviewedPapers.forEach((paper) => {
  if(ormsIDs.includes(paper.id)){
    ormsPapers.push(paper);
  } else {
    medicalPapers.push(paper);
  }
})
        ...
        <hr></hr>
          ...
          <div className='research-text'>
            <div>
                ...
                <p>Predictive modeling, data-driven optimization, stochastic dynamic programming, (partially observable) Markov decision processes, machine learning, stochastic optimization, (distributionally) robust optimization, applied statistics, simulation</p>
            </div>
          </div>
          ...
          <section>
            ...
            <div class = 'card mb-50'>
              ...
              <a data-toggle="collapse" href="#collapse-published" aria-expanded="true" aria-controls="collapse-published" id="heading-published" class="collapsible-header">
                  <i class="fa fa-chevron-down pull-right"></i>
                <h4 className='subtitle fw-bold publication-subtitle-card'>Healthcare Analytics and Medical Papers</h4>
              </a>
              </div>
              <div id="collapse-published" class="collapse show" aria-labelledby="heading-published">
                <div class = 'card-body'>
                  <ol>
                  { medicalPapers.map((pubs) => {
                  return (
                    <li className='break'>{pubs.text}<b>{pubs.journal}</b>{pubs.issue}<i>{pubs.status} </i>
                    { pubs.link != null && <a className='download-link' target='_blank' rel='noopener noreferrer' href={pubs.link}><i class="fa fa-solid fa-link"></i></a> }
                    { pubs.download != null && <a href={pubs.download} className="download-link" download><i class="fa fa-solid fa-download"></i></a> }
